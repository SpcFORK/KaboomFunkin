(() => {
  ...
  var wi, o, ps, _a, x, _a2, z2, bs, _a3, re, _a4, Ue, bi, vi, gs, _a5, wt, Pn, _a6, De, _a7, ce, _a8, vt, _a9, Mn, _a10, Ye, _a11, xt, _a12, Be, _a13, ye, _a14, Le, Vn, Ms, Rs, _a15, $t, kn, _a16, rt, _a17, jn, _a18, Nn, Ds, zt, Gs, Fs, Bs, Yt, it, _a19, Ut, Ls, Is, Vs, ks, Ai, js, Xt, Ns, Oi, Wt, Pi, _s, Hs, qs, $s, Ks, zs, Ys, Mi, _n, Ri, Di, Js, Jt, Qs, Xs, Ws, Gi, Fi, Hn, qn, Bi, Li, bo;
  var init_kaboom = __esm({
    "node_modules/kaboom/dist/kaboom.mjs"() {
      wi = Object.defineProperty;
      o = /* @__PURE__ */ __name((r, t) => wi(r, "name", { value: t, configurable: true }), "o");
      ps = (() => {
      ...
      __name(J, "J");
      o(J, "rgb");
      bs = o((r, t, u) => z2.fromHSL(r, t, u), "hsl2rgb");
      re = (/* @__PURE__ */ __name(_a3 = class {
        constructor(t, u, p, E) {
          __publicField(this, "x", 0);
          __publicField(this, "y", 0);
      ...
      vi = 12345;
      gs = 2147483648;
      wt = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a5 = class {
        constructor(t) {
      ...
      __name(As, "As");
      o(As, "sat");
      xt = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a11 = class extends Map {
        constructor(...t) {
          super(...t);
      ...
      ye = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a13 = class {
        constructor() {
      ...
      Le = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a14 = class {
        constructor() {
      ...
      __name(In, "In");
      o(In, "downloadBlob");
      Vn = o((r) => r.match(/^data:\w+\/\w+;base64,.+/), "isDataURL");
      Ms = o((r) => r.split(".").pop(), "getExt");
      Rs = (() => {
        let r = 0;
        return () => r++;
      })();
      $t = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a15 = class {
      ...
      jn = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a17 = class {
        constructor() {
      ...
      Nn = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a18 = class {
        constructor() {
      ...
      Ai = "3000.1.12";
      js = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
      Xt = "topleft";
      Ns = 64;
      Oi = "monospace";
      Wt = "monospace";
      ...
      Ri = 8;
      Di = 4;
      Js = [{ name: "a_pos", size: 2 }, { name: "a_uv", size: 2 }, { name: "a_color", size: 4 }];
      Jt = Js.reduce((r, t) => r + t.size, 0);
      Qs = 2048;
      Xs = Qs * 4 * Jt;
      Ws = Qs * 6;
      Gi = `
...
`;
      Bi = /* @__PURE__ */ new Set(["id", "require"]);
      Li = /* @__PURE__ */ new Set(["add", "update", "draw", "destroy", "inspect", "drawInspect"]);
      __name(ot, "ot");
      o(ot, "anchorPt");
      __name(Ii, "Ii");
      o(Ii, "alignPt");
...
`), font: Wt, pos: S(e, -e), anchor: "botleft", size: 16, width: be() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  // code/MLtoJSON.ts
  function MLtoJSON(htmlStr, type) {
  ...
  var _EO_, MLtoJSON_default;
  var init_MLtoJSON = __esm({
    "code/MLtoJSON.ts"() {
      __name(MLtoJSON, "MLtoJSON");
      __name(createMLProxy, "createMLProxy");
      _EO_ = {
        MLtoJSON,
        createMLProxy
      };
      MLtoJSON_default = _EO_;
    }
  });

  // code/weekParser.ts
  var bm_, weekParser_default;
  var init_weekParser = __esm({
    "code/weekParser.ts"() {
      init_MLtoJSON();
      bm_ = {
        getWeeks: (weekname) => __async(void 0, null, function* () {
          return yield fetch(weekname);
        }),
        getStoryWeeks: () => __async(void 0, null, function* () {
  ...
  // code/quickEvent.ts
  var om_, quickEvent_default;
  var init_quickEvent = __esm({
    "code/quickEvent.ts"() {
      om_ = {
        createStruct: (...args) => {
          return args.join(":");
  ...
  var require_main = __commonJS({
    "code/main.ts"(exports) {
      ...
      var CHROMEOS_FIX = !navigator.userAgent.includes("CrOS");
      {
        ...
        load(new Promise((resolve, reject) => __async(exports, null, function* () {
          let txts = yield fetch("code/txt.txt").then((res) => res.text());
          GLOBAL_LOADED_FILES.txts = txts;
          GLOBAL_LOADED_FILES.WEEKLIST = yield weekParser_default.getStoryWeeks();
          ...
          for (let week of weeklist) {
            ...
            if (weekTopText)
              GLOBAL_LOADED_FILES.RIGHTTOPTEXTCHOICES[weekName] = weekTopText;
            if (weekSongs)
              GLOBAL_LOADED_FILES.WEEKSONGS[weekName] = Object.values(weekSongs);
          }
          resolve(txts);
        })));
      ...
      function createBeatHandler() {
        ...
        return {
          activateBeat: function(bpm) {
            ...
            if (currentTime - lastBeatTime > beatInterval / 1e3) {
      ...
      __name(createBeatHandler, "createBeatHandler");
      function segPosCenter(pos2, divs, width2, ind) {
        return pos2 / divs * ind + width2 / 2;
      }
      __name(segPosCenter, "segPosCenter");
      function sleep(ms) {
        return __async(this, null, function* () {
      ...
      __name(sToMs, "sToMs");
      function drainOpacity(sprite2, duration) {
        return __async(this, null, function* () {
          return new Promise((resolve) => {
            sprite2.use(opacity(1));
            let currentOpacity = 1;
            const fadeAmount = 1 / (duration / 100);
            const interval = setInterval(() => {
              currentOpacity -= fadeAmount;
              if (currentOpacity <= 0) {
                sprite2.use(opacity(0));
                clearInterval(interval);
                resolve();
              } else {
                sprite2.use(opacity(currentOpacity));
              }
            }, 10);
          });
        });
      ...
      function makeIntroTransition(color2) {
        return __async(this, null, function* () {
          let fg = yield createFG();
          if (color2)
            fg.use(color2);
          yield drainOpacity(fg, sToMs(2));
          fg.destroy();
          return fg;
        });
      }
      __name(makeIntroTransition, "makeIntroTransition");
      function createPlayer(...args) {
        ...
        quickEvent_default.$(["player", "create"], {
          player: player_
        });
        return;
      }
      ...
      function createGhosty(...args) {
        ...
        quickEvent_default.$(["ghosty", "create"], {
          ghosty: gh_
        });
        return gh_;
      }
      __name(createGhosty, "createGhosty");
      function playMenuMusic() {
        let ms_ = SOUNDS.menuMusic = play("freakyMenu", {
          volume: 0.5,
          loop: true
        });
        quickEvent_default.$(["menuMusic", "play"], {
          music: ms_
        });
        return ms_;
      }
      __name(playMenuMusic, "playMenuMusic");
      ...
      __name(createMenuStructure, "createMenuStructure");
      function createEscapeHandle(ep, ...pass) {
        let a;
        return a = onKeyPress("escape", () => __async(this, null, function* () {
          yield makeTransition();
          yield sleep(sToMs(0.5));
          go(ep, ...pass);
          a.cancel();
        }));
      }
      __name(createEscapeHandle, "createEscapeHandle");
      var GameNavigator = class {
        constructor({ tab, topText, displayAllTabs = false, adj = 0 }) {
          this.navOpacity = 1;
          this.displayAllTabs = false;
          this.tabTexts = [];
          this.currentPos = 0;
          this.adj = 0;
          this.tab = tab;
        ...
        highlight() {
          ...
          (_a20 = this.tabTexts.find((textComp) => textComp.text === tabKeys[this.currentPos])) == null ? void 0 : _a20.use(color(YELLOW));
        }
        moveBar(direction) {
          const tabKeys = Object.keys(this.tab);
        ...
        enterTab() {
          ...
          if (tabAction) {
            this.tabTexts.find((textComp) => textComp.text === currentTab).use(color(225, 225 / 2, 0));
            if (typeof tabAction === "function") {
              let tsr = tabAction + "";
              if (tsr.includes("go(") && !tsr.trim().startsWith("(quick) =>") || tsr.trim().startsWith("(fade) =>")) {
      ...
      __name(GameNavigator, "GameNavigator");
      var ScrollableMenu = class {
        constructor(menu, posit) {
          this.menu = menu;
          this.pos = posit;
          this.currentIndex = -1;
      ...
      scene("songLoaded", () => {
        quickEvent_default.$(["songLoaded", "init"]);
        player = createPlayer();
      });
      scene("intro", () => __async(exports, null, function* () {
        quickEvent_default.$(["intro", "init"]);
        if (IS_IFRAME)
          playMenuMusic();
        else
          awaitingFirstInput = onClick(() => {
        ...
        let txToggle = /* @__PURE__ */ __name(() => txt.hidden = !txt.hidden, "txToggle");
        ...
        __name(gotoMenu, "gotoMenu");
        {
          yield sleep(sToMs(1.5));
          txToggle();
          yield sleep(sToMs(2.5));
          txToggle();
          txt.text = "Made by\n";
          yield sleep(sToMs(1));
          txt.text += "Spectcow";
          ...
          cowingLogo.hidden = true;
          cowingLogo.destroy();
          let ramdomchoice = GLOBAL_LOADED_FILES.txts.split("\n")[Math.floor(
            Math.random() * GLOBAL_LOADED_FILES.txts.split("\n").length
          )].replace("--", "\n");
          yield sleep(sToMs(1));
          txToggle();
          txt.text = ramdomchoice;
          txt.textSize = width() / 5 / (CHROMEOS_FIX ? 2 : 1);
          txt.width = width() - 200;
          yield sleep(sToMs(2));
          txToggle();
          yield sleep(sToMs(2));
        }
        !MENU_FLAG && (yield makeTransition(color(WHITE)), gotoMenu());
      }));
      scene("menu", () => __async(exports, null, function* () {
        quickEvent_default.$(["menu", "init"]);
        ...
        let scl = 0.5;
        let udc = onUpdate(() => __async(exports, null, function* () {
        ...
        function exit__() {
          [
            ...
            var _a20;
            return (_a20 = x2 == null ? void 0 : x2.cancel) == null ? void 0 : _a20.call(x2);
          });
        }
        __name(exit__, "exit__");
        yield makeIntroTransition(color(WHITE));
      }));
      scene("selectMenu", () => __async(exports, null, function* () {
        quickEvent_default.$(["selectMenu", "init"]);
        ...
        addEventListener("GameNavigator:tabChange", (e) => {
          var _a20, _b;
          tabs.bottom.infoText.text = (_b = tabs.bottom.infoText.INFOTEXTCHOICES[(((_a20 = e.detail) == null ? void 0 : _a20.text) + "").toLocaleLowerCase()]) != null ? _b : "(Press ENTER to select tab)";
          let sound_ = play("scrollMenu", {
            volume: 0.5
          });
        });
        addEventListener("GameNavigator:enter", (e) => {
          let sound_ = play("confirmMenu", {
            volume: 0.5
          });
        });
      ...
      scene("storyMode", () => __async(exports, null, function* () {
        quickEvent_default.$(["storyMode", "init"]);
        let tabs = createMenuStructure();
        ...
        let weeks = {
          ...
          [MOD_SYMBOL]: __spreadValues({}, window["WEEK_INJECTOR"])
        };
        Object.assign(window, {
          get WEEK_INJECTOR() {
            return weeks[MOD_SYMBOL];
          },
          set WEEK_INJECTOR(x2) {
            Object.assign(weeks[MOD_SYMBOL], x2 || { x: x2 });
          }
        });
        let menu = new ScrollableMenu(
          __spreadValues(__spreadValues({}, weeks), weeks[MOD_SYMBOL]),
          [-width() / 4, height() / 2 + 80]
        );
        let switchtexts = /* @__PURE__ */ __name((e) => {
          var _a20, _b, _c, _d;
          let ind = e.detail.text;
        ...
        addEventListener("ScrollableMenu:enter", (e) => {
          let sound_ = play("confirmMenu", {
            volume: 0.5
          });
        });
